...
function [d2,errf,msg] = sf_check_design(d)
% Make design into object, do conversions
errf = 0; msg = {};
if isfield(d, 'SPM')                 % Modified by Ali 24.04.2021
    d2 = des_struct(mardo_5, d.SPM); % d = mardo(d) & return d2 % 
else                                 % is_valid, error
    d2 = mardo(d);                   % design report, error.
end                                  %
if ~is_valid(d2)
  errf = 1; 
